...
import com.endless.study.baselibrary.utils.UtilCharacterHandler;
import com.endless.study.baselibrary.utils.UtilMediaType;
...
public class DefaultFormatPrinter implements IFormatPrinter {
    ...
    public void printJsonResponse(long chainMs, boolean isSuccessful, int code, @NonNull String headers,
        ...
        //根据类型进行转换
        bodyString = UtilMediaType.isJson(contentType) ? UtilCharacterHandler.jsonFormat(bodyString) :
                UtilMediaType.isXml(contentType) ? UtilCharacterHandler.xmlFormat(bodyString) : bodyString;
